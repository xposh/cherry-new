...
async function run() {
  ...
  await sql`DELETE FROM user_interactions WHERE from_user_id IN (SELECT id FROM users WHERE email LIKE '%seed.cherry')`;
  await sql`DELETE FROM talent_profiles   WHERE user_id       IN (SELECT id FROM users WHERE email LIKE '%seed.cherry')`;
  await sql`DELETE FROM company_profiles  WHERE user_id       IN (SELECT id FROM users WHERE email LIKE '%seed.cherry')`;
  await sql`DELETE FROM users             WHERE email LIKE '%seed.cherry'`;

  const hash = await bcrypt.hash("Cherry2025!", 12);
  ...
  const talents = [
    {
      ...
      data: {
        ...
        about:
          "Photographer mit 6 Jahren Erfahrung im Editorial- und Portraitbereich. Klare, cineastische Ästhetik für Mode und Lifestyle.",
    ...
    },
    {
      ...
      data: {
        ...
        specialty: "Color & Cut",
        about:
          "Leidenschaftliche Stylistin mit über 8 Jahren Erfahrung in Premium-Salons. Spezialisiert auf Balayage und Bridal Styling.",
        ...
        experiences: [
          {
            ...
            level: "Senior",
            description:
              "Kundenberatung, Colorierung und Schnitt im Premium-Segment.",
          },
        ],
        otherExperiences: [],
        languages: [
    ...
    },
    {
      ...
      data: {
        ...
        about:
          "Gewinner des NRW Latte Art Championships 2023. Ich bringe Precision und Kreativität an jede Siebträgermaschine.",
        ...
        experiences: [
          {
            ...
            level: "Mid",
            description:
              "Bar-Konzept, Training neuer Mitarbeiter und Quality Control.",
          },
        ],
        otherExperiences: [],
        languages: [
    ...
    },
    {
      ...
      data: {
        ...
        about:
          "Head Chef mit 10 Jahren Erfahrung in der gehobenen Gastronomie. Meine Küche verbindet asiatische Techniken mit europäischen Klassikern.",
        ...
        experiences: [
          {
            ...
            level: "Expert",
            description:
              "Signature-Menü, Küchenleitung für ein 2-Sterne-Restaurant.",
          },
          {
            id: "e2",
            title: "Sous Chef",
    ...
    },
    {
      ...
      data: {
        ...
        about:
          "Zertifizierte Pilates-Trainerin mit Passion für Körperbewusstsein. Ich kombiniere Reformer mit Aerial-Techniken für maximale Wirkung.",
  ...
  VALUES (${user.id}, ${sql.json(t.data)})
`;
  ...
  const companies = [
    {
      ...
      data: {
        ...
        description:
          "Preisgekröntes Architektur- und Designstudio aus Hamburg. Unser 15-köpfiges Team verbindet Funktionalität mit zeitloser Ästhetik.",
        ...
        contactPerson: {
          ...
          message:
            "Wir suchen eine kreative Persönlichkeit die mit uns neue Maßstäbe setzt.",
    ...
    },
    {
      ...
      data: {
        ...
        description:
          "Drei der bekanntesten Cocktailbars in Berlin. Wir stehen für Handwerk, Gastfreundschaft und Barkultur auf höchstem Niveau.",
    ...
    },
    {
      ...
      data: {
        ...
        description:
          "Kölns führende Specialty-Coffee-Rösterei mit eigenem Café-Konzept. Wir roasten single-origin Bohnen und begeistern täglich hunderte Gäste.",
    ...
    },
    {
      ...
      data: {
        ...
        description:
          "Hamburgs exklusivster Premium-Salon mit zwei Standorten in Eppendorf und der HafenCity. Standards in Farbbehandlung, Cut und Bridal Styling.",
        ...
        contactPerson: {
          ...
          message:
            "Du bist Künstlerin und Handwerkerin zugleich? Wir haben den richtigen Platz.",
          photo: "/Recruter-Hr/IMG_4415.JPG",
        },
      },
    },
    {
      ...
      data: {
        ...
        description:
          "Eines der gefragtesten Fine-Dining-Restaurants in Berlin. Wir kochen mit saisonalen Zutaten von regionalen Produzenten.",
  ...
  VALUES (${user.id}, ${sql.json(c.data)})
`;
