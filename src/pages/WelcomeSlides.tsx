      ...
      <div className="relative z-10 h-full flex flex-col justify-end p-8 md:p-16 pb-12">
        ...
        <div className="flex flex-col gap-4 max-w-sm w-full">
          ...
          <p className="text-white/40 text-[10px] leading-tight mt-4">
            Durch die Registrierung stimmst du unseren <span className="underline cursor-pointer">AGB</span> und <span className="underline cursor-pointer">Datenschutzbestimmungen</span> zu.
          </p>
        </div>
      </div>
    </div>
