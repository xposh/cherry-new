...
--
-- Name: set_updated_at(); Type: FUNCTION; Schema: public; Owner: posh
--
...
--
-- Name: conversations; Type: TABLE; Schema: public; Owner: posh
--
...
--
-- Name: featured_opportunities; Type: TABLE; Schema: public; Owner: posh
--

CREATE TABLE public.featured_opportunities (
    id integer NOT NULL,
...
--
-- Name: featured_opportunities_id_seq; Type: SEQUENCE; Schema: public; Owner: posh
--

CREATE SEQUENCE public.featured_opportunities_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: featured_opportunities_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: posh
--

ALTER SEQUENCE public.featured_opportunities_id_seq OWNED BY public.featured_opportunities.id;
...
--
-- Name: featured_opportunities id; Type: DEFAULT; Schema: public; Owner: posh
--

ALTER TABLE ONLY public.featured_opportunities ALTER COLUMN id SET DEFAULT nextval('public.featured_opportunities_id_seq'::regclass);
...
--
-- Name: conversations conversations_match_id_unique; Type: CONSTRAINT; Schema: public; Owner: posh
--
...
--
-- Name: conversations conversations_pkey; Type: CONSTRAINT; Schema: public; Owner: posh
--
...
--
-- Name: featured_opportunities featured_opportunities_pkey; Type: CONSTRAINT; Schema: public; Owner: posh
--

ALTER TABLE ONLY public.featured_opportunities
    ADD CONSTRAINT featured_opportunities_pkey PRIMARY KEY (id);
...
--
-- Name: idx_conversations_match_id; Type: INDEX; Schema: public; Owner: posh
--
...
--
-- Name: idx_featured_opps_owner_active; Type: INDEX; Schema: public; Owner: posh
--

CREATE INDEX idx_featured_opps_owner_active ON public.featured_opportunities USING btree (owner_id, is_active, deleted_at);
...
--
-- Name: idx_messages_conversation_id; Type: INDEX; Schema: public; Owner: posh
--
...
--
-- Name: uniq_daily_profile_view_summary; Type: INDEX; Schema: public; Owner: posh
--

CREATE UNIQUE INDEX uniq_daily_profile_view_summary ON public.activity_feed USING btree (user_id, activity_date) WHERE ((activity_type)::text = 'profile_view'::text);


--
-- Name: company_profiles trg_company_profiles_updated_at; Type: TRIGGER; Schema: public; Owner: posh
--
...
--
-- Name: talent_profiles trg_talent_profiles_updated_at; Type: TRIGGER; Schema: public; Owner: posh
--

CREATE TRIGGER trg_talent_profiles_updated_at BEFORE UPDATE ON public.talent_profiles FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
...
--
-- Name: conversations conversations_match_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: posh
--
...
--
-- Name: messages messages_conversation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: posh
--
